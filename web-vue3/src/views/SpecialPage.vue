<script setup>
import { specialImg } from '@/utils/imgs';
import { ref } from 'vue';
...
<template>
  <div class="rouge-page">
    ...
    <div class="list-wrapper">
      <ul class="list">
        <li class="list-item" v-for="item in specialImg" @mouseover="selectedItem(item, $event)" @mouseout="unselectedItem(item, $event)" @click="goToNav(item.name)">
